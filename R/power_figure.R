...
#
# Inputs match R/sample_size.R: current split 7/9, ICC 0.01, which
# gives SE = 0.645 and lambda = 2 / 0.645 = 3.10 at nu = 14 df.
# Output: figures/power_noncentral_t.png
# =====================================================================

suppressMessages(library(ggplot2))

nu  <- 14                 # k1 + k2 - 2 for 7 + 9 practices
se  <- 0.645              # SE of the treatment effect, 7/9, ICC 0.01
