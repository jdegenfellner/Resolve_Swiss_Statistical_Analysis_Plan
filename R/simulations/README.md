...
|---|---|---|
| Individually randomised trial needs 109/arm (Sample size) | power 0.80 | `01_individual_sample_size.R` |
| Baseline factor 1−r² reduces this to 70/arm (Sample size) | power 0.80 | `01_individual_sample_size.R` |
