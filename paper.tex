...
in section~\ref{sec:samplesize}; it is a deviation that has to be reported under
...
2.4 points and a standard deviation of about 0.9 --- but that 0.9 is the
precision-weighted spread of the pooled treatment-effect estimates from the two
previous studies \citep{waelti2015, bagg2022}, that is, uncertainty about the
true effect, whereas the quantity the formula requires is the between-participant
