...
treatment. The baseline is measured before allocation, so the arms share a
common baseline mean by design, and imposing that constraint is what lets the
model use the baseline information. This constrained longitudinal formulation
