...
collected at 26 and 52 weeks after the baseline measurement.
...
Read as a conventional superiority trial targeting a 2-point difference, by
contrast, 110 participants per arm is close to right
(section~\ref{sec:samplesize}). We therefore interpret the protocol's intent,
detecting a clinically meaningful difference of at least 2 points, in the
...
corresponding arm-by-time contrast, and the model additionally provides the
